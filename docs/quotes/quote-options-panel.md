...
- **Quote Settings** link (top right of panel) — Opens the full [Quote Settings](../quote-settings.md) page where margin, tax, and organization defaults live
...
**Related:** See [Quote Settings](../quote-settings.md) for organization-level defaults (margin, tax, labor categories, etc.).
